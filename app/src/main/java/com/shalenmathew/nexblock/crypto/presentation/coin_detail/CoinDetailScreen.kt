...
import com.shalenmathew.nexblock.crypto.presentation.coin_list.CoinListState
...
import com.shalenmathew.nexblock.crypto.presentation.model.toDisplayableNumber
import com.shalenmathew.nexblock.ui.theme.DarkGreen
import com.shalenmathew.nexblock.ui.theme.blackBackground
        ...
        Column(
            ...
            FlowRow(
                ...
                val contentColor = if(isPositive) {
                    if(isSystemInDarkTheme()) Color.Green else DarkGreen
                } else {
            ...
            AnimatedVisibility(
                ...
                LineChart(
                    ...
                    style = ChartStyle(
                        chartLineColor = yellowBackground,
                        unselectedColor = Color.White.copy(
                            alpha = 0.6f
                        ),
                        selectedColor = yellowBackground,
